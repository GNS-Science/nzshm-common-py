...
class RegionGrid(Enum):
    ...
    WLG_0_01_nb_1_1 = RegionGridEntry(region_name='WLG', resolution=0.01, neighbours=1, grid=WLG_0_01_nb_1_1(),
                                      version=1)
    WLG_0_05_nb_1_1 = RegionGridEntry(region_name='WLG', resolution=0.05, neighbours=1, grid=WLG_0_05_nb_1_1(),
                                      version=1)
