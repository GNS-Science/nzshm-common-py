...
def compress_path(source_path: str, output_zip: Union[str, PurePath]) -> str:
...
def compress_string(config: str) -> str:
...
def decompress_string(compressed: str) -> str:
    """Decompress an LZMA compressed string to the original string."""
