...
def test_string_compression_round_trip():
    random_input = ''.join(random.choices(string.ascii_uppercase + string.digits, k=1024))
...
def test_compress_path_round_trip():
    ...
    with tempfile.NamedTemporaryFile(prefix='Random_data_', dir=tmpdirname, mode='w') as fileA:
